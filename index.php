...
<body style="background-image: url(images/bg2.jpg);">
    ...
    <div class="form" id="aboutus">
        <form class="box2">
           ...
           <div class="cont">
            <img src="images/Fem_Dev.jpg" alt="Nivedi Kondlekar">
            <div class="info">
                <ul>
                    <a href="https://www.linkedin.com/in/nivedi-kondlekar-8b812721a/">Nivedi Kondlekar</a><br>
                    <li>8208582333</li><br>
                    <li><a href="mailto:nivedikondlekar@gmail.com">nivedikondlekar@gmail.com</a></li><br>
                    <li>Dwarkadas J. Sanghvi College of Engineering, Mumbai</li><br>
                </ul>
            </div>
        </div>
           <div class="cont">
